...
10. Неуспешная покупка тура с не валидным номером карты (1 цифра). 
* Перейти на страницу покупки тура
* Нажать на кнопку "Купить"
...
11. Неуспешная покупка тура с не валидным номером карты. 
* Перейти на страницу покупки тура
* Нажать на кнопку "Купить"
...
29. Неуспешная покупка тура в кредит с не валидным номером карты (1 цифра). 
* Перейти на страницу покупки тура
* Нажать на кнопку "Купить в кредит"
* Заполнить поле "Номер карты" не валидными данными: 4
* Заполнить поле "Месяц" валидными данными: 08
...
30. Неуспешная покупка тура в кредит с не валидным номером карты. 
* Перейти на страницу покупки тура
* Нажать на кнопку "Купить в кредит"
* Заполнить поле "Номер карты" не валидными данными: 1234 5678 9012 3456
* Заполнить поле "Месяц" валидными данными: 08
